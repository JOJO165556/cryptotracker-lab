...
class OrderModel(models.Model):
	...
	wallet = models.ForeignKey("wallet.WalletModel", on_delete=models.CASCADE, related_name="orders")
...
class TradeModel(models.Model):
	id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
	order = models.ForeignKey(OrderModel, on_delete=models.CASCADE, related_name="trades")
