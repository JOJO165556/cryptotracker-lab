    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filled_quantity', models.DecimalField(decimal_places=8, default='0.00000000', max_digits=18)),
                ...
                ('wallet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='wallet.walletmodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trades', to='trading.ordermodel')),
            ],
            options={
